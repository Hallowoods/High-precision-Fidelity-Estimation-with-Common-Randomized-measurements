...
#     # # N_m = 1000000
#     # N_m = 10
#     # filename = f'A_Small_repetion,shadow_norm,Nm={N_m}_snk_state_n={nqubit},k={k},{current_time}.csv'
#     # filename = f'shadow_norm_ghz_state_nqubit={nqubit}_Nm={N_m}_{current_time}.csv'
#     # filename = f'4design_variance_changing:Nm={N_m},for_snk_state_n={nqubit},k={k},{current_time}.csv'
#     filename = f'clifford_variance_changing:Nm={N_m},for_snk_state_n={nqubit},k={k},{current_time}.csv'
...
def main(nqubit, k, N_m):
    ...
    # 修改为你的目标路径
    folder_path = rf"D:\probability-expectation-project\clifford_variance_changing_Nm\k={k}"
