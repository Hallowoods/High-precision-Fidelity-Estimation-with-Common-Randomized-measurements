...
z0 Pauli noise is assumed. (Fig. S8)
...
def main(nqubit,N_m):
    ...
    magnitudelist = np.linspace(0,1.0,21)          # A parameter to control the range of infidelity
    
    
    #target state generation |ghz_n\>
...
if __name__ == "__main__":
    ...
    nlist = [2,3,4,5,6,7]
    for nqubit in nlist:
        full_path = main(nqubit=nqubit,N_m=N_m)
        variance_amp_values = []
